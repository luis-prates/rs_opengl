...
pub fn main_2_4_1() {
	...
	let (lighting_shader, lamp_shader, vbo, cube_vao, cube_positions, light_vao, diffuse_map) = unsafe {
		...
		(lighting_shader, lamp_shader, vbo, cube_vao, cube_positions, light_vao, diffuse_map)
	};
